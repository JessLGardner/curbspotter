...
bball = Post.create({title: 'Fisher Price Basketball Hoop', content: "My kids are too big for this now. This basketball hoop extends from 4 feet to 6 feet in height. The hoop is in decent condition, just a bit weathered by the elements.", image_url: 'https://images.craigslist.org/00N0N_4G8cw5TAlRA_600x450.jpg', category: 'kids', location: '926 Howard Street, Atlanta, GA 30306'})
sink = Post.create({title: 'sink basin w/faucet', content: "A clam shell sink basin with Price Pfister faucet - dirty from being in a car port and some pool/tub toys that have mildew on them, but a little Tilex should remove it. Easy porch/yard pickup.", image_url: 'https://images.craigslist.org/00b0b_8XeQPAttTBy_600x450.jpg', category: 'construction', location: '8738 Beechwood Dr, Atlanta, GA 30324'})
cabinet = Post.create({title: 'huge filing cabinets', content: "Saw these big guys on my morning walk, they look to be in pretty good condition", image_url: 'https://images.craigslist.org/00505_41Fo4pmkmrW_600x450.jpg', category: 'furniture', location: '649 Oakwood Rd, Atlanta, GA 30308'})
stuff = Post.create({title: 'so much stuff!!', content: "Dressers, chairs, cabinets, TV, bench, treadmill and more. Some items in excellent condition, some need a bit of attention, or a little cleaning. First come, first serve. It'll all be gone by Tuesday. Bring a truck!", image_url: 'https://images.craigslist.org/00j0j_9UQnELPcMHH_600x450.jpg', category: 'furniture', location: '514 S. Magnolia St., Atlanta, GA 30317'})
couch = Post.create({title: 'Couch', content: "Grab and Go!", image_url: 'https://images.craigslist.org/00c0c_i0ZaTpuMgeN_600x450.jpg', category: 'furniture', location: '496 Hamilton St., Atlanta 30312'})
skier = Post.create({title: 'Nordic Track Skier', content: "Nordic Track Pro ski exercize machine. First come, first served, on the curb", image_url: 'https://images.craigslist.org/00X0X_agiL7CIGtKL_600x450.jpg', category: 'fitness', location: '8089 E. Glenwood Drive, Atlanta, GA 30306'})
kennel = Post.create({title: 'small dog kennel', content: "Kennel will be on driveway today. No need to come to door, just take it if you want it.", image_url: 'https://images.craigslist.org/00L0L_3RurZkay9wX_600x450.jpg', category: 'pets', location: '477 Ridgeview Ave, Atlanta, GA 30316'})
